...
/**
 * Full-viewport admin console shell: a persistent grouped sidebar rail + sticky topbar, with
 * the routed page in the main area. Rendered outside RootLayout (its own chrome, no marketing
