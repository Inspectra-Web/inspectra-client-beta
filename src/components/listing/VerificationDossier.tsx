  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-6 max-sm:flex-col max-sm:items-start">
        <div>
          ...
          <p className="mt-2 max-w-md text-sm text-muted">
            Every check INSPECTRA ran on this home before it went live — the
            same paperwork a careful lawyer would demand, done for you.
          </p>
        </div>
      ...
      <p className="mt-5 text-xs leading-relaxed text-faint">
        Checks re-run automatically when the seller updates a document. Flagged
        items pause new inspection bookings until they're resolved.
      </p>
    </section>
  );
}
